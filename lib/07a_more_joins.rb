...
def expensive_tastes
  ...
  execute(<<-SQL)
    ...
    JOIN
      albums a ON a.asin = n.album
    JOIN
      styles s ON s.album = a.asin
    WHERE a.price / tc IS NOT NULL
    ORDER BY
      a.price / tc DESC
      LIMIT 20
  SQL
